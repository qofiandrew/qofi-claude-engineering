...
PY
  ...
  # single-quoted line in the generated launcher below.
...
# generated by swarm-up.sh — per-swarm codex-bridge launcher for '$name'
export DISCORD_STATE_DIR='$state_dir'
export CODEX_BRIDGE_CWD='$repo'
export CODEX_BRIDGE_PREAMBLE_EXTRA='$doctrine'
exec bun '$SWARM_HOME/codex-bridge/daemon.ts'
EOF
