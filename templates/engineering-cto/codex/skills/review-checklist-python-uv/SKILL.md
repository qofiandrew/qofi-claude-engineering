...
description: "R5 review checklist and native verification commands for Python diffs using the uv toolchain. Load when reviewing a matching stack."
---

# Codex route to the canonical skill

From the repository root, open
`.claude/skills/review-checklist-python-uv/SKILL.md`, read it completely, and
