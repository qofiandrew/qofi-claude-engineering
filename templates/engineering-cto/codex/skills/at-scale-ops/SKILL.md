---
name: at-scale-ops
description: "At-scale and batch-operation playbook covering idempotency, resumability, status tracking, streaming, observability, and operator controls."
---

# Codex route to the canonical skill

From the repository root, open `.claude/skills/at-scale-ops/SKILL.md`, read it
