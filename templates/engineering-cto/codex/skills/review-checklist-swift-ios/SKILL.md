...
description: "R5 review checklist and native verification commands for Swift and iOS diffs. Load when reviewing a matching stack."
---

# Codex route to the canonical skill

From the repository root, open
`.claude/skills/review-checklist-swift-ios/SKILL.md`, read it completely, and
